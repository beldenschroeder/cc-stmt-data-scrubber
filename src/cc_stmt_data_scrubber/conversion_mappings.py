...
FAMILY_DESC_CONVERSIONS = {
    ...
    "Bloomsgiving": r"\*?\bBLOOMSGIVING\b",
    ...
    "Oral-B": r"\*?\bORAL B\b",
    "Pérez Bros. Farms": r"\*?\bPRZBROFARMS\b",
    ...
    "REI": r"\*?\bREI.COM\b",
    "RHJ Organic": r"\*?\bRHJ ORGANIC\b",
    "Ritual Coffee": r"\*?\bRITUAL COFFEE\b",
    "Rojas Family Farms": r"\*?\bROJAS FAMILY FARMS\b",
    ...
    "Saint Frank Coffee": r"\*?\bSAINT FRANK COFFEE\b",
    ...
    "Whole Foods": r"\*?\bWHOLE FOODS\b|\*?\bWHOLEFDS\b",
